package org.curiouslearning.containerdevdev.utilities;

import android.app.Activity;
import android.content.Intent;
import android.net.Uri;
import android.util.Log;
import org.curiouslearning.containerdev.MainActivity;
...
public class DeepLinkHelper {
    ...
    private static void redirectToPlayStore(Activity activity) {
        ...
        Intent marketIntent = new Intent(Intent.ACTION_VIEW,
                Uri.parse("https://play.google.com/store/apps/details?id=org.curiouslearning.containerdev"));
