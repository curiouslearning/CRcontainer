...
public class DebugOverlayManager {
        ...
        public DebugOverlayManager(Context context, View offlineOverlay, View debugTriggerArea, SharedPreferences prefs,
                        SharedPreferences utmPrefs, ReferralManager referralManager, String appVersion) {
                                ...
                                public void onClick(View v) {
                                        ...
                                        if (debugTapCount >= REQUIRED_TAPS) {
                                                ...
                                                if (offlineOverlay != null) {
                                                        ...
                                                        offlineOverlay.setElevation(24 * context.getResources()
        ...
        public void updateDebugOverlay() {
                ...
                debugInfo.append("Selected Language: ").append(selectedLanguage.isEmpty() ? "None" : selectedLanguage)
                                .append("\n");
                debugInfo.append("Stored Language: ").append(prefs.getString("selectedLanguage", "None"))
                                .append("\n\n");

                // Events Section
                debugInfo.append("=== Events ===\n");
                debugInfo.append("Started In Offline Mode Event Sent: ").append(isOffline).append("\n");
                debugInfo.append("Initial Slack Alert Time: ")
                                .append(AppUtils.convertEpochToDate(referralManager.getInitialSlackAlertTime()))
                                .append("\n");
                debugInfo.append("Current Time: ")
                                .append(AppUtils.convertEpochToDate(AnalyticsUtils.getCurrentEpochTime()))
                                .append("\n");
