...
public class ReferralManager {
        ...
        public void init() {
                InstallReferrerManager.ReferrerCallback referrerCallback = new InstallReferrerManager.ReferrerCallback() {
                        ...
                        public void onReferrerStatusUpdate(InstallReferrerManager.ReferrerStatus status) {
                                ...
                                if (listener != null)
                                        listener.onReferrerStatusUpdate(status);
                        }
                        ...
                        public void onReferrerReceived(String deferredLang, String fullURL) {
                                ...
                                if (!isReferrerHandled) {
                                        ...
                                        if ((language != null && language.length() > 0)
                                                ...
                                                SharedPreferences installReferrerPrefs = context.getSharedPreferences(
                                                                "InstallReferrerPrefs",
                                                                Context.MODE_PRIVATE);
                                                SharedPreferences.Editor installReferrerEditor = installReferrerPrefs
                                                                .edit();
                                                ...
                                                if (listener != null)
                                                        listener.onUpdateDebugOverlay(); // Always update the overlay

                                                validLanguage(language, "google",
                                                ...
                                                // We don't set selectedLanguage here directly, we let
                                                // validLanguage/listener handle it
                                        ...
                                        if (selectedLanguage.equals("")) {
                                                ...
                                                if (listener != null)
                                                        listener.onLanguageReceived(selectedLanguage);
                                        }
                                }
                        }
                };
        ...
        public void fetchFacebookDeferredData() {
                AppLinkData.fetchDeferredAppLinkData(context, new AppLinkData.CompletionHandler() {
                        ...
                        public void onDeferredAppLinkDataFetched(AppLinkData appLinkData) {
                                ...
                                // Note: Dialog dismissal was here in MainActivity, but here we can just ensure
                                // we proceed
        ...
        private void validLanguage(String deferredLang, String source, String deepLinkUri) {
                ...
                message.append("User affected:: ").append(pseudoId).append("\n")
                                .append("Detected in data at: ").append(AppUtils.convertEpochToDate(currentEpochTime))
                                .append("\n")
                                .append("Alerted in Slack: ")
                                .append(AppUtils.convertEpochToDate(initialSlackAlertTime));
                ...
                homeViewModal.getAllLanguagesInEnglish().observe(lifecycleOwner, validLanguages -> {
                        ...
                        if (lowerCaseLanguages != null && lowerCaseLanguages.size() > 0
                                ...
                                // loadingIndicator visibility logic left to MainActivity via callbacks if
                                // needed
                                ...
                                String lang = Character.toUpperCase(language.charAt(0))
                                                + language.substring(1).toLowerCase();
                                if (listener != null)
                                        listener.onLanguageReceived(lang);
                        } else if (lowerCaseLanguages == null || lowerCaseLanguages.size() == 0) {
                                if (listener != null)
                                        listener.onLanguageReceived(isValidLanguage);
                        }
                });
        }
